...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        // PENAMBAHAN: SingleChildScrollView agar layar tidak overflow
              ...
              children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: const [
                          ...
                          Text(
                            "2311102148 - Muhammad Deka Maulana",
                            style: TextStyle(
                              fontSize: 14,
                ...
                Container(
                  ...
                  child: ListView.builder(
                    // Tambahkan physics ini agar scroll ListView tidak bentrok dengan SingleChildScrollView
                ...
                // Tambahan Container Navigation berada di sini
                Container(
